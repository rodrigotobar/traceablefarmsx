...
//
// Solidity: function getFootprintVerifierValidator(string _checkerUrl) view returns((string,address))
...
// SetFootprintVerifierValidator is a paid mutator transaction binding the contract method 0xed2f96b9.
//
// Solidity: function setFootprintVerifierValidator(string _checkerUrl, string _checkerHash, address _txHash) returns()
func (_TraceableFarms *TraceableFarmsTransactor) SetFootprintVerifierValidator(opts *bind.TransactOpts, _checkerUrl string, _checkerHash string, _txHash common.Address) (*types.Transaction, error) {
...
//
// Solidity: function setFootprintVerifierValidator(string _checkerUrl, string _checkerHash, address _txHash) returns()
func (_TraceableFarms *TraceableFarmsSession) SetFootprintVerifierValidator(_checkerUrl string, _checkerHash string, _txHash common.Address) (*types.Transaction, error) {
...
//
// Solidity: function setFootprintVerifierValidator(string _checkerUrl, string _checkerHash, address _txHash) returns()
func (_TraceableFarms *TraceableFarmsTransactorSession) SetFootprintVerifierValidator(_checkerUrl string, _checkerHash string, _txHash common.Address) (*types.Transaction, error) {
	return _TraceableFarms.Contract.SetFootprintVerifierValidator(&_TraceableFarms.TransactOpts, _checkerUrl, _checkerHash, _txHash)
}
